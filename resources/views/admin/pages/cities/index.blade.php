                        ...
                        @foreach($cities as $index => $city)
                            <tr>
                                ...
                                <td class="text-center">
                                    <button data-url="{{route('admin.cities.info',['id' => $city->id])}}" class="btn-modal-view icon-btn green-bc">
                                        <i class="fa fa-pencil"></i>
                                        تعديل
                                    </button>
                                    <button data-url="{{route('admin.cities.delete',['id' => $city->id])}}" data-toggle="modal" data-target="#delete_user" class="icon-btn red-bc deleteBTN">
